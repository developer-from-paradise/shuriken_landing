# # Shuriken soft Landing
This repository contains the code for the landing page of Shuriken soft for winning in competitions. The landing page is designed to provide an engaging and informative experience for visitors. The page has been built using SCSS, Gulp, and Babel to ensure a smooth development process and an optimized user experience.

# Features
1.  **Attractive Design**: The landing page is designed to capture the essence of rich people. It features vibrant visuals, engaging animations, and an intuitive layout.
    
2.  **Server Information**: Visitors can quickly access essential information about Shuriken soft.
...
4.  **Interactive Elements**: The page includes interactive elements like buttons, accessing the forums, and connecting with our community on social media.
...
1.  Clone this repository to your local machine:
    `git clone https://github.com/developer-from-paradise/shuriken_landing.git` 
...
## Preview
[Link to preview page](https://developer-from-paradise.github.io/shuriken_landing/build/)